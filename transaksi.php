			...
			<table class="table table-bordered" style="margin-top:10px;"> 
				<tr >
				 ...
				 <?php
				      include 'inc/dbconn.php';
<<<<<<< HEAD
				      $query = mysqli_query($db,"SELECT * FROM transaksi ORDER BY T_ID ASC");
               		  $rows = mysqli_num_rows($query);

=======
				      $query = "SELECT * FROM transaksi ORDER BY T_ID ASC";
...
>>>>>>> master
				      ...
				      while($data = mysqli_fetch_array($query))
				      {
				        ...
				        echo "<tr>";
				        echo "<td>$data[t_id]</td>"; //menampilkan data id
				        echo "<td>$data[g_id]</td>"; 
				        echo "<td>$data[t_totalharga]</td>";
